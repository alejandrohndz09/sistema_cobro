...
@section('content')
    <div class="container-fluid ">
        <div class="row">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody id="tableBody">
                                        @foreach ($empresas as $empresa)
                                            <tr>
                                                <td class="ps-4">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $empresa->idEmpleado }}</p>
                                                </td>
                                                <td>
                                                    <div>
                                                        <img src="{{ $empresa->logo }}" class="avatar avatar-sm me-3"
                                                            alt="Logo">
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $empresa->nit }}</p>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">{{ $empresa->nombre }}</p>
                                                </td>
                                                <td class="text-center">
            ...
            <div class="col-lg-3">
                <div class="row p-2 dropdown mb-2">
                    <a href="#" class="btn bg-gradient-dark dropdown-toggle  text text-transform-none "
