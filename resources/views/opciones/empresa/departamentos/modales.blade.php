            ...
            <div class="modal-body p-0 ">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        ...
                        <p id="dialogoDepartamento" class="mb-0">Está a punto de deshabilitar el registro. ¿Desea
                            continuar?</p>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-mg" role="document">
        <div class="modal-content">
            <div class="modal-body p-0 ">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="text-dark" id="tituloSucursal"></h3>
                        <p class="mb-0">(*) Campos Obligatorios</p>
                    </div>
                    <div class="card-body">
                        <form role="form text-left" id="sucursalForm">
                            @csrf
                            <input type="hidden" name="_method" id="methodC" value="PUT"> <!-- Para edición -->
                            <input type="hidden" name="evaluar" id="evaluar" value="">
                            <div class="row mb-4">

                                <label>Teléfono: *</label>
                                <div class="input-group mb-1">
                                    <input type="text" name="telefono" id="telefono" class="form-control"
                                        placeholder="(+503) 0000-0000" autocomplete="off" oninput="validarInput(this)">
                                </div>
