...
@section('content')
    <div class="container-fluid ">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div
                                                    ...
                                                    <i class="fas fa-home opacity-10 text-xl text-white"
                                            ...
                                            <div class="col-lg-6 ms-3 mt-5 mt-lg-0">
                                                ...
                                                <div class="d-flex flex-column h-100">
                                                    <h2 class="font-weight-bolder mb-2">Sucursal {{ $sucursal->ubicacion }}
                                                    </h2>
                                                    <h2 class="font-weight-bolder mb-2">{{ $sucursal->nombre }}</h2>
                                                    ...
                                                    @if ($sucursal->estado == 1)
                                                        <a role="button" data-bs-toggle="modal"
                                                            data-bs-target="#modalFormS" data-id="{{ $sucursal->idSucursal }}"
                                        ...
                                        <tbody id="tableBody">
                                            @foreach ($departamentos as $c)
                                                <tr>
                                                    ...
                                                    <td class="px-1">
                                                        <p class="text-xs font-weight-bold mb-0">{{ $c->idDepartamento }}
                                                        </p>
                                                    </td>
                                                    <td class="px-1">
        ...
        @include('opciones.empresa.departamentos.modales')
    @endsection
