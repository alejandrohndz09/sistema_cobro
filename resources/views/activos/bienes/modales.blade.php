                    ...
                    <div class="card-body">
                        <form role="form text-left" enctype="multipart/form-data" id="bienForm">
                            ...
                            <div class="row" id="panelAdquisicion">
                                ...
                                <div class="col-xl-6" id="sucursal-container">
                                ...
                                <div class="col-xl-6" id="departamento-container">
                                ...
                                <div class="col-xl-12" id="help-container">
                                ...
                                <div id="tableDepartamentos" class="table-responsive ">
                                    <table class="table mb-0 align-items-center">
                                        <thead>
                                            ...
                                            <th class="px-0">
                                                <button data-bs-tt="tooltip"
                                                    data-bs-original-title="Añadir lote de adquisición."
                                                    class="btn btn-sm bg-gradient-dark btnAgregarAd mb-0">
                                        ...
                                        <tbody id="tableBodyDepartamentos">
                                            <tr>
                                                ...
                                                <td class="ps-4 col-4">
                                                    <select name="sucursales[]" class="form-control selectSucursal"
                                                        style="max-width: 150px"></select>
                                                    <span id="error-sucursales.1"
                                                ...
                                                <td class="ps-4 col-4">
                                                    ...
                                                    <span id="error-departamentos.1"
                                                        class="sp-departamento text-danger text-xs mb-3"></span>
                                                </td>
                                                <td class="px-4 col-4"></td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-body p-0 ">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        ...
                        <p id="dialogo" class="mb-0">Está a punto de deshabilitar el registro. ¿Desea
                            continuar?
                        </p>
                    </div>
                    <div class="card-body">
                        <form role="form text-left" id="confirmarForm">
                            ...
                            <span id="error-motivo" class="text-danger text-xs mb-3"></span>
                            <div class="text-end">
                                <button type="reset" data-bs-dismiss="modal" style="border-color:transparent"
                                    class="btn btn-outline-dark btn-sm mt-4 mb-0">
