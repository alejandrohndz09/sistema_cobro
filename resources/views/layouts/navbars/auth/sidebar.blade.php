<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('inicio') }}">
            <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Cuentas Claras System</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: 100vh">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Menu principal</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('gestión-comercial') ? 'active' : '' }}"
                    href="{{ url('gestión-comercial') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Gestión comercial</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('activos') ? 'active' : '' }} " href="{{ url('activos') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Gestión de activo fijo</span>
                </a>
            </li>

            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('opciones') ? 'active' : '' }}" href="{{ url('opciones') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Otras Opciones</span>
                </a>
            </li>
            <li class="nav-item mt-6">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Plantillas (Para inspirarse)
                </h6>
            </li>
